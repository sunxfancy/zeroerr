...
// This emoji map is coverted from Textualize/rich project from python.
const std::map<std::string, const char*>& getEmojiMap() {
    static std::map<std::string, const char*> emojiMap = {
        {"1st_place_medal", "🥇"},
        {"2nd_place_medal", "🥈"},
        {"3rd_place_medal", "🥉"},
